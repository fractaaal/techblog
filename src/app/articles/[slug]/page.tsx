...
export default async function Article({ params }: Props) {
  ...
  return (
    <div className='max-w-4xl relative mx-auto pb-10'>
      <div>
      ...
      <div className='flex justify-start gap-2 w-4/5 px-6 my-4'>
        <TagList tags={article.tags} />
      </div>

      <div className='flex justify-center items-start gap-6'>
        <div className='relative w-4/5 cms-content pb-20 bg-white rounded-xl p-4'>
          <ReactMarkdown
            components={{
              pre: Pre,
            }}
